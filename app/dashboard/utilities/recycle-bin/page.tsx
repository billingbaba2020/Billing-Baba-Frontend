...
import {
  ...
  Search,
  Trash2,
  ArrowUpDown, // Using this as a generic filter/sort icon
} from "lucide-react";
...
// Reusable component for table headers with filter icons
        ...
        <CardHeader className="p-4 border-b">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm bg-gray-200 text-gray-600 px-3 py-1.5 rounded-l-md">Between</span>
                    <Input defaultValue="04/09/2025" className="w-32 rounded-none"/>
                    <span className="text-sm bg-gray-200 text-gray-600 px-3 py-1.5">To</span>
                    <Input defaultValue="04/09/2025" className="w-32 rounded-l-none rounded-r-md"/>
