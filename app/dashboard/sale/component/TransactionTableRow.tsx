...
import { Transaction } from '@/lib/types'; // Assuming your type definition is here
import { SharePopover } from '@/components/dashboard/SharePopover'; // Import the reusable SharePopover
