    ...
    if (isCreating) {
        return (
            <div className="bg-slate-50 p-4 sm:p-6 lg:p-8 min-h-screen">
                <CreateDebitNotePage onCancel={() => setIsCreating(false)} />
            </div>
        );
    }
                    ...
                    <Table>
                        <TableHeader className="bg-slate-50">
                            <TableRow>
                                ...
                                <TableHead>PRINT / SHARE</TableHead>
                            </TableRow>
                        </TableHeader>
                        <TableBody><TableRow><TableCell colSpan={10}><EmptyStateIllustration /></TableCell></TableRow></TableBody>
                    </Table>
                </div>
