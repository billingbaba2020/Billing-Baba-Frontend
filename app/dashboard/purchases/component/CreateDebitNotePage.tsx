...
export default function CreateDebitNotePage({ onCancel }: { onCancel: () => void }) {
    ...
    return (
        <div className="bg-white rounded-lg shadow-md">
            <div className="p-6 space-y-8">
                {/* --- हेडर --- */}
                <h1 className="text-2xl font-bold text-gray-800">Debit Note</h1>
                ...
                {/* --- ऊपरी सेक्शन --- */}
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-3">
                        <div className="flex items-center justify-end"><label className="text-sm text-gray-500 w-32">Return No.</label><Input disabled className="w-48 bg-gray-50" /></div>
