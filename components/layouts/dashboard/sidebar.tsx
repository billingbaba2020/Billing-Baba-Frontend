...
const menuItems: MenuItem[] = [
  ...
  {
    name: "Parties", icon: Users, type: "dropdown", path: "/dashboard/party/details", subItems: [
  ...
  {
    name: "Utilities", icon: RotateCcw, type: "dropdown", path: "/dashboard/utilities/import-items", subItems: [
