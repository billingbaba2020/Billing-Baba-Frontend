...
const salePageTypes: SalePageType[] = [ "Sale Invoices", "Estimate/Quotation", "Proforma Invoice", "Payment-In", "Sale Order", "Delivery Challan", "Sale Return", "Billing Baba POS" ];
