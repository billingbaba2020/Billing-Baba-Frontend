...
// Custom SVG icon for the 'xls' file, styled to match the image
const XlsIcon = () => (
...
// Custom SVG icon for the upload area, styled to match the image
const UploadIcon = () => (
    <div className="relative">
            ...
            <main className="p-4 sm:p-8 flex items-center justify-center">
                <div className="w-full max-w-5xl mx-auto">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                        ...
                        <div className="flex flex-col items-center justify-start text-center space-y-8 pt-8">
                        ...
                        <div className="relative h-full hidden md:block">
                             <Separator orientation="vertical" className="absolute h-full top-0 left-0"/>
                        </div>

                        {/* Right Column: Upload */}
                        <div className="flex flex-col items-center justify-start text-center space-y-4 pt-8">
                            <p className="font-semibold text-gray-700">Upload your .xls/.xlsx (excel sheet)</p>
                            <div className="w-full h-full flex flex-col items-center justify-center border-2 border-dashed border-gray-300 rounded-lg p-16">
                                <UploadIcon />
